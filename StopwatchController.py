...
class MyStopwatchController:
    ...
    def __init__(self):
        ...
        # do the handling
        self._button1 = Button(18, "button1", buttonhandler=None)
        self._button2 = Button(17, "stop", buttonhandler=None)
        self._timekeeper = TimeKeeper()
        self._display = LCDDisplay(sda=0, scl=1, i2cid=0)
        self._myledgreen = Light(27, "Internal LED")
        self._myledred = Light(21, "Internal LED")
